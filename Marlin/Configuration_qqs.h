...
#define Z_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop. // qq-s false=nc, true=no
#define X_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // set to true to invert the logic of the probe. // qq-s false=nc, true=no
...
// Use stm32 internal flash as eeprom storage
